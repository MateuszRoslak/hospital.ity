...
class CleaningRequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cleaning_request" do
    assert_difference('CleaningRequest.count') do
      post cleaning_requests_url, params: { cleaning_request: { description: @cleaning_request.description, title: @cleaning_request.title, user_id: @cleaning_request.user_id } }
    end
  ...
  test "should update cleaning_request" do
    patch cleaning_request_url(@cleaning_request), params: { cleaning_request: { description: @cleaning_request.description, title: @cleaning_request.title, user_id: @cleaning_request.user_id } }
